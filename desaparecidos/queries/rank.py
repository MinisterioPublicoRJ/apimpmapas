...
SELECT
    ...
    ALVO_DT_FATO,
    CASE
       WHEN VITM_CAND.VTMA_DT_NASCIMENTO IS NULL
        THEN IDADE_APARENTE_CAND.SIDP_NM_IDADE_APARENTE
        ELSE TO_CHAR(floor(MONTHS_BETWEEN(INFO_CAND.SNCA_DT_FATO, VITM_CAND.VTMA_DT_NASCIMENTO) / 12))
        END AS IDADE,
