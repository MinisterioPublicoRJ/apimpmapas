# Generated by Django 2.2.4 on 2019-08-21 13:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('last_modified', models.DateTimeField(auto_now=True)),
                ('dado', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lupa.Dado')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('last_modified', models.DateTimeField(auto_now=True)),
                ('mapa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lupa.Mapa')),
            ],
            options={
                'abstract': False,
            },
