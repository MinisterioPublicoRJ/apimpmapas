    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geojson_column', models.CharField(blank=True, max_length=200, null=True, verbose_name='coluna de dados GEOJSON da entidade')),
                ('osm_value_attached', models.CharField(blank=True, choices=[('suburb', 'Bairro'), ('municipality', 'Município')], max_length=50, null=True, verbose_name='TAG osm_values atrelada')),
                ('osm_default_level', models.BooleanField(default=False, verbose_name='busca de geolocalização padrão')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', colorfield.fields.ColorField(default='#000000', max_length=18, verbose_name='cor das caixinhas')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('last_modified', models.DateTimeField(auto_now=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roles_allowed', models.ManyToManyField(blank=True, help_text='Deixar em branco para todos', related_name='data_allowed', to='lupa.Grupo', verbose_name='grupos com acesso')),
                ('theme', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='data_by_theme', to='lupa.TemaDado', verbose_name='tema da caixinha')),
            ],
            options={
                'ordering': ('order',),
                'abstract': False,
