...
from dominio.pip.dao import PIPTaxaResolutividadeDAO, QUERIES_DIR
...
class TestPIPIndicadoresSucesso:
    ...
    def test_serialize_result_set(self):
        result_set = [(0.133,)]
        ser_data = PIPTaxaResolutividadeDAO.serialize(result_set)
    ...
    def test_get_data_404_exception(self, _serialize, _execute):
        ...
        with pytest.raises(APIEmptyResultError):
            PIPTaxaResolutividadeDAO.get(orgao_id=orgao_id)
