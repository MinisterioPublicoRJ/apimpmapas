...
class TempoTramitacaoSerializer(serializers.Serializer):
    id_orgao = serializers.IntegerField()
    media_orgao = serializers.FloatField()
    minimo_orgao = serializers.IntegerField()
    maximo_orgao = serializers.IntegerField()
    mediana_orgao = serializers.FloatField()
    media_pacote = serializers.FloatField()
    minimo_pacote = serializers.IntegerField()
    maximo_pacote = serializers.IntegerField()
    mediana_pacote = serializers.FloatField()
    media_pacote_t1 = serializers.FloatField()
    minimo_pacote_t1 = serializers.IntegerField()
    maximo_pacote_t1 = serializers.IntegerField()
    mediana_pacote_t1 = serializers.FloatField()
    media_orgao_t1 = serializers.FloatField()
    minimo_orgao_t1 = serializers.IntegerField()
    maximo_orgao_t1 = serializers.IntegerField()
    mediana_orgao_t1 = serializers.FloatField()
    media_pacote_t2 = serializers.FloatField()
    minimo_pacote_t2 = serializers.IntegerField()
    maximo_pacote_t2 = serializers.IntegerField()
    mediana_pacote_t2 = serializers.FloatField()
    media_orgao_t2 = serializers.FloatField()
    minimo_orgao_t2 = serializers.IntegerField()
    maximo_orgao_t2 = serializers.IntegerField()
    mediana_orgao_t2 = serializers.FloatField()
