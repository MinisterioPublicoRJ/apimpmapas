...
# ARCGIS
ARCGIS_TOKEN_ENDPOINT = config("ARCGIS_TOKEN_ENDPOINT")
ARCGIS_TOKEN_USERNAME = config("ARCGIS_TOKEN_USERNAME")
ARCGIS_TOKEN_PASSWORD = config("ARCGIS_TOKEN_PASSWORD")
ARCGIS_TOKEN_EXPIRATION= config("ARCGIS_TOKEN_EXPIRATION", cast=int, default=24 * 60)
ARCGIS_TOKEN_CLIENT = config("ARCGIS_TOKEN_CLIENT")
